  CREATE TABLE CLIENTES 
   ...
   CODIGOCLIENTE INT NOT NULL PRIMARY KEY, 
	...
	CODIGOEMPLEADOREPVENTAS INT NOT NULL, 
	LIMITECREDITO Varchar(15) NOT NULL
   );
	ALTER TABLE Clientes
	ALTER COLUMN LIMITECREDITO decimal(15,2);

 
    CREATE TABLE GAMASPRODUCTOS 
   (	GAMA VARCHAR(50), 
	DESCRIPCIONTEXTO VARCHAR (50), 
	DESCRIPCIONHTML VARCHAR(50), 
	IMAGEN varchar(50)
   ); 
  ...
  CREATE TABLE PEDIDOS 
   ...
   (	CODIGOPRODUCTO VARCHAR(15) not null primary key, 
	NOMBRE VARCHAR(70), 
	GAMA VARCHAR(50 ), 
	DIMENSIONES VARCHAR(25 ), 
	PROVEEDOR VARCHAR(50 ) NOT NULL, 
	DESCRIPCION VARCHAR(50), 
	CANTIDADENSTOCK decimal(15,0), 
   ...
   CODIGOPEDIDO INT FOREIGN KEY REFERENCES PEDIDOS(CODIGOPEDIDO), 
	CODIGOPRODUCTO VARCHAR(15) FOREIGN KEY REFERENCES PRODUCTOS(CODIGOPRODUCTO),
   	CANTIDAD INT, 
	PRECIOUNIDAD INT, 
	NUMEROLINEA INT
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values (5,'Tendo Garden','Akane','Tendo','55591233210','55591233211','Street nº69','null','Miami','null','USA','696969',22,600000);
...
---------------------------------------------------------------------------------------------------------------------
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values (1,'Marcos','Magaña','Perez','3897','marcos@jardineria.es','TAL-ES',0,'Director General');
...
-------------------------------------------------------------------------
 CREATE TABLE OFICINAS 
   (	CODIGOOFICINA VARCHAR(10) NOT NULL PRIMARY KEY, 
	CIUDAD VARCHAR(30), 
	PAIS VARCHAR(50), 
	REGION VARCHAR(50) NOT NULL, 
...
----------------------------------------------------------------------------------------------
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (1,'PayPal','ak-std-000001','10/12/08',2000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (1,'PayPal','ak-std-000002','12/10/08',2000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (3,'PayPal','ak-std-000003','16/01/09',5000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (3,'PayPal','ak-std-000004','16/02/09',5000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (3,'PayPal','ak-std-000005','19/02/09',926);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (4,'PayPal','ak-std-000006','08/01/07',20000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (4,'PayPal','ak-std-000007','08/01/07',20000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (4,'PayPal','ak-std-000008','08/01/07',20000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (4,'PayPal','ak-std-000009','08/01/07',20000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (4,'PayPal','ak-std-000010','08/01/07',1849);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (5,'Transferencia','ak-std-000011','18/01/06',23794);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (7,'Cheque','ak-std-000012','13/01/09',2390);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (9,'PayPal','ak-std-000013','06/01/09',929);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (13,'PayPal','ak-std-000014','04/08/08',2246);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (14,'PayPal','ak-std-000015','15/07/08',4160);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (15,'PayPal','ak-std-000016','15/01/09',2081);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (15,'PayPal','ak-std-000035','15/02/09',10000);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (16,'PayPal','ak-std-000017','16/02/09',4399);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (19,'PayPal','ak-std-000018','06/03/09',232);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (23,'PayPal','ak-std-000019','26/03/09',272);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (26,'PayPal','ak-std-000020','18/03/08',18846);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (27,'PayPal','ak-std-000021','08/02/09',10972);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (28,'PayPal','ak-std-000022','13/01/09',8489);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (30,'PayPal','ak-std-000024','16/01/09',7863);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (35,'PayPal','ak-std-000025','10/06/07',3321);
Insert into PAGOS (CODIGOCLIENTE,FORMAPAGO,IDTRANSACCION,FECHAPAGO,CANTIDAD) values (38,'PayPal','ak-std-000026','26/05/06',1171);

-----------------------------------------------------------------------------------------------------------------
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (1,'17/01/06','19/01/06','19/01/06','Entregado',5);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (2,'23/10/07','28/10/07','26/10/07','Entregado',5);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (3,'20/06/08','25/06/08',null,'Rechazado',5);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (4,'20/01/09','26/01/09',null,'Pendiente',5);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (8,'09/11/08','14/11/08','14/11/08','Entregado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (9,'22/12/08','27/12/08','28/12/08','Entregado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (10,'15/01/09','20/01/09',null,'Pendiente',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (11,'20/01/09','27/01/09',null,'Pendiente',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (12,'22/01/09','27/01/09',null,'Pendiente',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (13,'12/01/09','14/01/09','15/01/09','entregado',7);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (14,'02/01/09','02/01/09',null,'rechazado',7);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (15,'09/01/09','12/01/09','11/01/09','entregado',7);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (16,'06/01/09','07/01/09','15/01/09','entregado',7);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (17,'08/01/09','09/01/09','11/01/09','entregado',7);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (18,'05/01/09','06/01/09','07/01/09','entregado',9);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (19,'18/01/09','12/02/09',null,'pendiente',9);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (20,'20/01/09','15/02/09',null,'pendiente',9);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (21,'09/01/09','09/01/09','09/01/09','rechazado',9);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (22,'11/01/09','11/01/09','13/01/09','entregado',9);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (23,'30/12/08','10/01/09',null,'Rechazado',5);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (24,'14/07/08','31/07/08','25/07/08','Entregado',14);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (25,'02/02/09','08/02/09',null,'Rechazado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (26,'06/02/09','12/02/09',null,'Rechazado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (27,'07/02/09','13/02/09',null,'Entregado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (28,'10/02/09','17/02/09','20/02/09','Entregado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (29,'01/08/08','01/09/08','01/09/08','Rechazado',14);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (30,'03/08/08','03/09/08','31/08/08','Entregado',13);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (31,'04/09/08','30/09/08','04/10/08','Rechazado',13);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (32,'07/01/07','19/01/07','27/01/07','Entregado',4);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (33,'20/05/07','28/05/07','null','Rechazado',4);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (34,'20/06/07','28/06/08','28/06/08','Entregado',4);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (35,'10/03/08','20/03/09',null,'Rechazado',4);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (36,'15/10/08','15/12/08','10/12/08','Entregado',14);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (37,'03/11/08','13/11/09',null,'Pendiente',4);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (38,'05/03/09','06/03/09','07/03/09','Entregado',19);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (39,'06/03/09','07/03/09','09/03/09','Pendiente',19);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (40,'09/03/09','10/03/09','13/03/09','Rechazado',19);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (41,'12/03/09','13/03/09','13/03/09','Entregado',19);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (42,'22/03/09','23/03/09','27/03/09','Entregado',19);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (43,'25/03/09','26/03/09','28/03/09','Pendiente',23);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (44,'26/03/09','27/03/09','30/03/09','Pendiente',23);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (45,'01/04/09','04/03/09','07/03/09','Entregado',23);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (46,'03/04/09','04/03/09','05/03/09','Rechazado',23);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (47,'15/04/09','17/03/09','17/03/09','Entregado',23);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (48,'17/03/08','30/03/08','29/03/08','Entregado',26);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (50,'17/03/08','09/08/08',null,'Pendiente',26);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (51,'01/10/08','14/10/08','14/10/08','Entregado',26);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (52,'07/12/08','21/12/08',null,'Pendiente',26);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (53,'15/10/08','15/11/08','09/11/08','Entregado',13);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (54,'11/01/09','11/02/09',null,'Pendiente',14);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (55,'10/12/08','10/01/09','11/01/09','Entregado',14);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (56,'19/12/08','20/01/09',null,'Rechazado',13);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (57,'05/01/09','05/02/09',null,'Pendiente',13);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (58,'24/01/09','31/01/09','30/01/09','Entregado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (59,'09/11/08','14/11/08','14/11/08','Entregado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (60,'22/12/08','27/12/08','28/12/08','Entregado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (61,'15/01/09','20/01/09',null,'Pendiente',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (62,'20/01/09','27/01/09',null,'Pendiente',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (63,'22/01/09','27/01/09',null,'Pendiente',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (64,'24/01/09','31/01/09','30/01/09','Entregado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (65,'02/02/09','08/02/09',null,'Rechazado',1);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (66,'06/02/09','12/02/09',null,'Rechazado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (67,'07/02/09','13/02/09',null,'Entregado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (68,'10/02/09','17/02/09','20/02/09','Entregado',3);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (74,'14/01/09','22/01/09',null,'Rechazado',15);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (75,'11/01/09','13/01/09','13/01/09','Entregado',15);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (76,'15/11/08','23/11/08','23/11/08','Entregado',15);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (77,'03/01/09','08/01/09',null,'Pendiente',15);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (78,'15/12/08','17/12/08','17/12/08','Entregado',15);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (79,'12/01/09','13/01/09','13/01/09','Entregado',28);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (80,'25/01/09','26/01/09',null,'Pendiente',28);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (81,'18/01/09','24/01/09',null,'Rechazado',28);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (82,'20/01/09','29/01/09','29/01/09','Entregado',28);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (83,'24/01/09','28/01/09',null,'Entregado',28);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (89,'05/10/07','13/12/07','10/12/07','Entregado',35);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (90,'07/02/09','17/02/08',null,'Pendiente',27);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (91,'18/03/09','29/03/09','27/03/09','Entregado',27);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (92,'19/04/09','30/04/09','03/05/09','Entregado',27);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (93,'03/05/09','30/05/09','17/05/09','Entregado',27);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (94,'18/10/09','01/11/09',null,'Pendiente',27);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (95,'04/01/08','19/01/08','19/01/08','Entregado',35);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (96,'20/03/08','12/04/08','13/04/08','Entregado',35);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (97,'08/10/08','25/11/08','25/11/08','Entregado',35);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (98,'08/01/09','13/02/09',null,'Pediente',35);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (99,'15/02/09','27/02/09',null,'Pendiente',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (100,'10/01/09','15/01/09','15/01/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (101,'07/03/09','27/03/09',null,'Rechazado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (102,'28/12/08','08/01/09','08/01/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (103,'15/01/09','20/01/09','24/01/09','Pendiente',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (104,'02/03/09','06/03/09','06/03/09','Entregado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (105,'14/02/09','20/02/09',null,'Rechazado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (106,'13/05/09','15/05/09','20/05/09','Pendiente',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (107,'06/04/09','10/04/09','10/04/09','Entregado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (108,'09/04/09','15/04/09','15/04/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (109,'25/05/06','28/07/06','28/07/06','Entregado',38);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (110,'19/03/07','24/04/07','24/04/07','Entregado',38);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (111,'05/03/08','30/03/08','30/03/08','Entregado',36);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (112,'05/03/09','06/04/09','07/05/09','Pendiente',36);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (113,'28/10/08','09/11/08','09/01/09','Rechazado',36);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (114,'15/01/09','29/01/09','31/01/09','Entregado',36);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (115,'29/11/08','26/01/09','27/02/09','Pendiente',36);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (116,'28/06/08','01/08/08','01/08/08','Entregado',38);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (117,'25/08/08','01/10/08',null,'Rechazado',38);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (118,'15/02/09','27/02/09',null,'Pendiente',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (119,'10/01/09','15/01/09','15/01/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (120,'07/03/09','27/03/09',null,'Rechazado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (121,'28/12/08','08/01/09','08/01/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (122,'09/04/09','15/04/09','15/04/09','Entregado',16);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (123,'15/01/09','20/01/09','24/01/09','Pendiente',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (124,'02/03/09','06/03/09','06/03/09','Entregado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (125,'14/02/09','20/02/09',null,'Rechazado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (126,'13/05/09','15/05/09','20/05/09','Pendiente',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (127,'06/04/09','10/04/09','10/04/09','Entregado',30);
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values (128,'10/11/08','10/12/08','29/12/08','Rechazado',38);
